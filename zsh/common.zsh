...
alias abc='mpv --stream-lavf-o="reconnect=1,reconnect_at_eof=1,reconnect_streamed=1,reconnect_delay_max=5" http://www.abc.net.au/res/streaming/audio/aac/news_radio.pls'
alias bgm="mpv --volume=46 --no-video --loop-playlist --volume-max=300 --display-tags= --script-opts=stats-key_page_0=6 --script=$HOME/repos/dotfiles/zsh/scripts/auto-stats.lua 'https://www.youtube.com/playlist?list=PLkVD01XL1G9LNt5iprsJYrqOcqtYNUh3e'"
